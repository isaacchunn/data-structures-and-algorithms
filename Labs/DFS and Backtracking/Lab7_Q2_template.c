...
/// @brief Conducts depth first search, but using recursive (backtracking i guess)
/// @param g graph
/// @param v vertex to start
void DFS_R (Graph_DFS g, int v)
{
    //Now our graph already holds the visited, as opposted to the iterative version.

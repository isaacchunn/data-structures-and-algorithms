...
int main()
{
    ...
    //TEST CASE
    //INSERT A
    insertNode(&ll_a,ll_a.size, 1);
    insertNode(&ll_a,ll_a.size, 2);
    insertNode(&ll_a,ll_a.size, 3);
    insertNode(&ll_a,ll_a.size, 4);
    insertNode(&ll_a,ll_a.size, 5);

    //INSERT B
    insertNode(&ll_b,ll_b.size, 6);
    insertNode(&ll_b,ll_b.size, 7);
    insertNode(&ll_b,ll_b.size, 8);
    insertNode(&ll_b,ll_b.size, 9);
    insertNode(&ll_b,ll_b.size, 10);
